...
public class ApiHttpClient {
	// public final static String HOST = "192.168.1.104";// hostµÿ÷∑
	// private static String API_URL = "http://192.168.1.104/eshop/%s";
	public final static String HOST = App.getApp().getHostIP();
	private static String API_URL = "http://" + App.getApp().getHostIP()
			+ "/%s";
