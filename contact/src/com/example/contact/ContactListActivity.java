...
public class ContactListActivity extends ActivityGroup implements
		IXListViewListener {
	...
	public void threadGetOrderFirst() {
		try {
			...
			ServerApi.getUserList("0", String.valueOf(page), handler);
